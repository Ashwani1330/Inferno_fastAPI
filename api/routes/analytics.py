...
def optimize_plot(fig, title, dpi=80, quality=80, format='webp', max_width=800):
    ...
    # Save figure to buffer without the "optimize" parameter
    buf = io.BytesIO()
...
# Generate HTML dashboard
        ...
        img_str = optimize_plot(fig, 'Distribution of Performance Scores')
        
        html += f"""
                        <div class="chart-container">
                            <h3>Performance Score Distribution</h3>
                            <img src="{img_str}" width="100%">
                        </div>
        """
        ...
        img_str = optimize_plot(fig, 'Average Time by Task')
        ...
        if 'date' in df.columns:
            ...
            img_str = optimize_plot(fig, 'Participation Trend')
        ...
        if 'numeric_age' in df.columns:
            ...
            img_str = optimize_plot(fig, 'Age Distribution of Participants')
        ...
        if 'age_group' in df.columns:
            ...
            img_str = optimize_plot(fig, 'Performance Score by Age Group')
            ...
            img_str = optimize_plot(fig, 'Time Metrics by Age Group')
        ...
        if 'sceneType' in df.columns:
            ...
            img_str = optimize_plot(fig, 'Distribution by Scene Type')
        ...
        if 'sceneType' in df.columns:
            ...
            img_str = optimize_plot(fig, 'Performance Score by Scene Type')
        ...
        if 'difficulty' in df.columns:
            ...
            img_str = optimize_plot(fig, 'Performance Score by Difficulty Level')
        ...
        img_str = optimize_plot(fig, 'Normalized Task Performance Comparison')
        ...
        img_str = optimize_plot(fig, 'Correlation Matrix')
        ...
        if 'numeric_age' in df.columns:
            ...
            img_str = optimize_plot(fig, 'Age vs Performance Score')
        ...
        if 'timestamp' in df.columns:
            ...
            img_str = optimize_plot(fig, 'Performance Scores Over Time')
            ...
            img_str = optimize_plot(fig, 'Average Daily Performance')
            ...
            img_str = optimize_plot(fig, 'Task Times Trend Over Time')
